/*=========================================================================
  ...
  Module:    vtkMultiVolumeTexture.h
 ...
 *   -# Volume masks are currently not being streamed. They need to use a vtkMultiVolumeTexture
 ...
 *
 * @warning This is an internal class of vtkOpenGLGPUMultiVolumeRayCastMapper. It assumes
...
#ifndef vtkMultiVolumeTexture_h
#define vtkMultiVolumeTexture_h
...
class VTKRENDERINGVOLUMEOPENGL2_EXPORT vtkMultiVolumeTexture : public vtkObject
{
  typedef vtkTuple<int, 6> Size6;
  typedef vtkTuple<int, 3> Size3;

public:
  static vtkMultiVolumeTexture* New();
  ...
  vtkTypeMacro(vtkMultiVolumeTexture, vtkObject);
  void PrintSelf( ostream& os, vtkIndent indent ) VTK_OVERRIDE;

  /**
   * Set the parent volume mapper and initialize internals.
   */
  void SetMapper(vtkOpenGLGPUMultiVolumeRayCastMapper* mapper);
...
protected:
  vtkMultiVolumeTexture();
  ~vtkMultiVolumeTexture() VTK_OVERRIDE;
...
private:
  ...
  vtkMultiVolumeTexture(const vtkMultiVolumeTexture&) VTK_DELETE_FUNCTION;
  void operator=(const vtkMultiVolumeTexture&) VTK_DELETE_FUNCTION;
