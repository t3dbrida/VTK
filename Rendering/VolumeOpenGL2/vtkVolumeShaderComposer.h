...
namespace vtkvolume
{
                                      ...
                                      int independentComponents)
  {
    ...
    toShaderStr << "#define TYPE_VOLUME 0\n"
                   ...
                   "\n";
    toShaderStr << "float g_stepT[" << numInputs << "];\n";
                       ...
                       int lightingComplexity)
  {
    ...
    if (inputCount > 1)
    {
        shaderStr += "\
          ...
          \n  {\
          \n    g_stepT[i] = volumeParameters.data[i].scalarsRange_gradMagMax_sampling.w;\
    ...
    else
    {
        str += "\n"
            ...
            str +=
                ...
                "        if (in_useJittering)\n"
                "        {\n"
                "          volDataPos += g_rayJitter * g_dirStep;\n"
                "        }\n"
                "        else\n"
                "        {\n"
      ...
      default:
      {
        ...
        //for (auto& item : inputs)
        {
          ...
          toShaderStr <<
              ...
              "            vec4 intRegionResultColor = getIntRegionColor(volumeParameters.data[0].intRegionIndex.x, intRegionValue);\n"
              "          }\n"
              "\n"
              "          g_srcColor = vec4(0.);\n"
