        ...
        str += "\n"
            ...
            if (bitRegion.mask)
            {
                str +=
                    ...
                    "        segTMax = vec3(g_rayDir.x != 0. ? (g_rayDirSign.x * (nextGridLine.x - g_eyePosObj.x) * g_tDelta[0].x) : FLOAT_MAX,\n"
                    "                       g_rayDir.y != 0. ? (g_rayDirSign.y * (nextGridLine.y - g_eyePosObj.y) * g_tDelta[0].y) : FLOAT_MAX,\n"
                    "                       g_rayDir.z != 0. ? (g_rayDirSign.z * (nextGridLine.z - g_eyePosObj.z) * g_tDelta[0].z) : FLOAT_MAX);\n"
