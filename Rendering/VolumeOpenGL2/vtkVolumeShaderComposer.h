...
namespace vtkvolume
{
                                      ...
                                      int independentComponents)
  {
    ...
    toShaderStr << "\n"
                   ...
                   "    int index0 = 2 * i,\n"
                   "        index1 = index0 + 1;\n"
                   "    marks[index0].t = intervals[i].tEnter;\n"
                   "    marks[index0].volumeIndex = i;\n"
                   "    marks[index0].entered = true;\n"
                   "    marks[index1].t = intervals[i].tExit;\n"
                   "    marks[index1].volumeIndex = i;\n"
                   "    marks[index1].entered = false;\n"
                   ...
                   "  {\n"
                   "    if (marks[i].entered == true && marks[i].t < 0)\n"
                   "    {\n"
                   "      marks[i].t = 0;\n"
                   "    }\n"
                   "  }\n"
                          ...
                          vtkVolume* vtkNotUsed(vol))
  {
    ...
    if (inputCount > 1)
    {
      ...
      /*str += "\n"
        ...
        "      if (intervals[i].valid == true && t >= intervals[i].tEnter && t <= intervals[i].tExit)\n"
        "      {\n"
        "        float intervalRange = intervals[i].tExit - intervals[i].tEnter;\n"
        ...
        "      {\n"
        "        if (marks[i].entered == true && t < marks[i].t)\n"
        "        {\n"
        "          t = marks[i].t;\n"
        "          idx = marks[i].volumeIndex;\n"
        "          g_dataPos = (ip_inverseTextureDataAdjusted * vec4(g_eyePosObj.xyz + t * g_rayDir, 1.)).xyz;\n"
        "          break;\n"
        "        }\n"
        "      }\n"
        "      if (idx < 0)\n"
