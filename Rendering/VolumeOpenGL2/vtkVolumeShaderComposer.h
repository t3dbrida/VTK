                          ...
                          vtkVolume* vol)
  {
    ...
    else
    {
        str += "\n"
            ...
            "    {\n"
            "      vec3 cs = volumeParameters.data[0].cellSpacing.xyz;\n"
            "      vec3 bboxMin = volumeParameters.data[i].boundsMin.xyz - .0001 * cs;\n"
            "      vec3 bboxMax = volumeParameters.data[i].boundsMax.xyz + .0001 * cs;\n"
            ...
            if (bitRegion.mask)
            {
                str +=
                    ...
                    "        vec3 samplePos = gridCorner + .5 * cs; // sampling at the voxel center\n"
                    "\n"
