/*=========================================================================
  ...
  Module:    vtkOpenGLMultiVolumeRGBTable.h
...
#ifndef vtkOpenGLMultiVolumeRGBTable_h
#define vtkOpenGLMultiVolumeRGBTable_h
...
//----------------------------------------------------------------------------
class vtkOpenGLMultiVolumeRGBTable : public vtkObject
{
public:

  static vtkOpenGLMultiVolumeRGBTable* New();
...
protected:
  ...
  //--------------------------------------------------------------------------
  ~vtkOpenGLMultiVolumeRGBTable() VTK_OVERRIDE
  {
    if (this->TextureObject)
    {
      this->TextureObject->Delete();
...
private:
  vtkOpenGLMultiVolumeRGBTable(const vtkOpenGLMultiVolumeRGBTable&)
    VTK_DELETE_FUNCTION;
  vtkOpenGLMultiVolumeRGBTable& operator=(const vtkOpenGLMultiVolumeRGBTable&)
    VTK_DELETE_FUNCTION;
};

vtkStandardNewMacro(vtkOpenGLMultiVolumeRGBTable);


////////////////////////////////////////////////////////////////////////////////
class vtkOpenGLMultiVolumeRGBTables
{
public:
  //--------------------------------------------------------------------------
  vtkOpenGLMultiVolumeRGBTables(unsigned int numberOfTables)
  {
    this->Tables.reserve(static_cast<size_t>(numberOfTables));

    for (unsigned int i = 0; i < numberOfTables; i++)
    {
      vtkOpenGLMultiVolumeRGBTable* table = vtkOpenGLMultiVolumeRGBTable::New();
      this->Tables.push_back(table);
    }
  }

  //--------------------------------------------------------------------------
  ~vtkOpenGLMultiVolumeRGBTables()
  {
  ...
  //--------------------------------------------------------------------------
  vtkOpenGLMultiVolumeRGBTable* GetTable(unsigned int i)
  {
...
private:
  std::vector<vtkOpenGLMultiVolumeRGBTable*> Tables;

  vtkOpenGLMultiVolumeRGBTables() VTK_DELETE_FUNCTION;

  vtkOpenGLMultiVolumeRGBTables(const vtkOpenGLMultiVolumeRGBTables &other) VTK_DELETE_FUNCTION;

  vtkOpenGLMultiVolumeRGBTables &operator=(const vtkOpenGLMultiVolumeRGBTables &other) VTK_DELETE_FUNCTION;
};

#endif // vtkOpenGLMultiVolumeRGBTable_h
// VTK-HeaderTest-Exclude: vtkOpenGLMultiVolumeRGBTable.h
