/*=========================================================================
  ...
  Module:    vtkOpenGLMultiVolumeGradientOpacityTable.h
...
#ifndef vtkOpenGLMultiVolumeGradientOpacityTable_h
#define vtkOpenGLMultiVolumeGradientOpacityTable_h
...
//----------------------------------------------------------------------------
class vtkOpenGLMultiVolumeGradientOpacityTable : public vtkObject
{
public:

  static vtkOpenGLMultiVolumeGradientOpacityTable* New();
...
protected:
  //--------------------------------------------------------------------------
  vtkOpenGLMultiVolumeGradientOpacityTable(int width = 1024)
  {
  ...
  //--------------------------------------------------------------------------
  ~vtkOpenGLMultiVolumeGradientOpacityTable() VTK_OVERRIDE
  {
      if (this->TextureObject)
      {
        this->TextureObject->Delete();
...
private:
  vtkOpenGLMultiVolumeGradientOpacityTable(const vtkOpenGLMultiVolumeGradientOpacityTable&)
    VTK_DELETE_FUNCTION;
  vtkOpenGLMultiVolumeGradientOpacityTable& operator=(
    const vtkOpenGLMultiVolumeGradientOpacityTable&) VTK_DELETE_FUNCTION;
};

vtkStandardNewMacro(vtkOpenGLMultiVolumeGradientOpacityTable);


////////////////////////////////////////////////////////////////////////////////
class vtkOpenGLMultiVolumeGradientOpacityTables
{
public:
  //--------------------------------------------------------------------------
  vtkOpenGLMultiVolumeGradientOpacityTables(unsigned int numberOfTables)
  {
    this->Tables.reserve(static_cast<size_t>(numberOfTables));

    for (unsigned int i = 0; i < numberOfTables; i++)
    {
      vtkOpenGLMultiVolumeGradientOpacityTable* table =
        vtkOpenGLMultiVolumeGradientOpacityTable::New();
      this->Tables.push_back(table);
    }
  }

  //--------------------------------------------------------------------------
  ~vtkOpenGLMultiVolumeGradientOpacityTables()
  {
  ...
  //--------------------------------------------------------------------------
  vtkOpenGLMultiVolumeGradientOpacityTable* GetTable(unsigned int i)
  {
...
private:
  std::vector<vtkOpenGLMultiVolumeGradientOpacityTable*> Tables;

  vtkOpenGLMultiVolumeGradientOpacityTables() VTK_DELETE_FUNCTION;

  vtkOpenGLMultiVolumeGradientOpacityTables(const vtkOpenGLMultiVolumeGradientOpacityTables &other) VTK_DELETE_FUNCTION;

  vtkOpenGLMultiVolumeGradientOpacityTables &operator=(const vtkOpenGLMultiVolumeGradientOpacityTables &other) VTK_DELETE_FUNCTION;
};

#endif // vtkOpenGLMultiVolumeGradientOpacityTable_h
// VTK-HeaderTest-Exclude: vtkOpenGLMultiVolumeGradientOpacityTable.h
