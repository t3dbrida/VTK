...
=========================================================================*/
/**
 * @class   vtkMultiVolumeMapper
 * @brief   Abstract class for a volume mapper
 *
 *
 * vtkMultiVolumeMapper is the abstract definition of a volume mapper for multiple
 * vtkImageData datasets.
*/

#ifndef vtkMultiVolumeMapper_h
#define vtkMultiVolumeMapper_h
...
#ifndef VTK_CROP_SUBVOLUME
#define VTK_CROP_SUBVOLUME              0x0002000
#endif
#ifndef VTK_CROP_FENCE
#define VTK_CROP_FENCE                  0x2ebfeba
#endif
#ifndef VTK_CROP_INVERTED_FENCE
#define VTK_CROP_INVERTED_FENCE         0x5140145
#endif
#ifndef VTK_CROP_CROSS
#define VTK_CROP_CROSS                  0x0417410
#endif
#ifndef VTK_CROP_INVERTED_CROSS
#define VTK_CROP_INVERTED_CROSS         0x7be8bef
#endif

class vtkWindow;

class VTKRENDERINGVOLUME_EXPORT vtkMultiVolumeMapper : public vtkAbstractMultiVolumeMapper
{
public:
  vtkTypeMacro(vtkMultiVolumeMapper,vtkAbstractMultiVolumeMapper);
  void PrintSelf( ostream& os, vtkIndent indent ) VTK_OVERRIDE;

  //@{
  /**
   * Set/Get the input data on input connection
   */
  virtual void SetInputData( int, vtkImageData * );
  virtual void SetInputData( int, vtkDataSet * );
  vtkImageData *GetInput(int = 0);
  //@}
   ...
   * the sampling ray.
   *
   * \note vtkMultiVolumeMapper::AVERAGE_INTENSITY_BLEND is only supported by the
   * vtkGPUVolumeRayCastMapper with the OpenGL2 backend.
   * \sa SetAverageIPScalarRange()
   */
  vtkSetMacro( BlendMode, int );
  void SetBlendModeToComposite()
    { this->SetBlendMode( vtkMultiVolumeMapper::COMPOSITE_BLEND ); }
  void SetBlendModeToMaximumIntensity()
    { this->SetBlendMode( vtkMultiVolumeMapper::MAXIMUM_INTENSITY_BLEND ); }
  void SetBlendModeToMinimumIntensity()
    { this->SetBlendMode( vtkMultiVolumeMapper::MINIMUM_INTENSITY_BLEND ); }
  void SetBlendModeToAverageIntensity()
    { this->SetBlendMode( vtkMultiVolumeMapper::AVERAGE_INTENSITY_BLEND ); }
  void SetBlendModeToAdditive()
    { this->SetBlendMode( vtkMultiVolumeMapper::ADDITIVE_BLEND ); }
   ...
   * Render the volume
   */
  void Render(vtkRenderer *ren, vtkMultiVolume2 *vol) VTK_OVERRIDE =0;
...
protected:
  vtkMultiVolumeMapper();
  ~vtkMultiVolumeMapper() VTK_OVERRIDE;
...
private:
  vtkMultiVolumeMapper(const vtkMultiVolumeMapper&) VTK_DELETE_FUNCTION;
  void operator=(const vtkMultiVolumeMapper&) VTK_DELETE_FUNCTION;
};
