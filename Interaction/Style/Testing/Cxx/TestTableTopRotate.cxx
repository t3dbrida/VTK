...
int TestTableTopRotate(int argc, char* argv[])
{
  ...
  vtkNew<vtkTableTopRotate> manipulator;
  ...
  interactor->SetEventInformation(200, 200, 0, 0, 0, 0);
  ...
  expectedPosition = { 0.285973, 6.25405, 0.403255 };
